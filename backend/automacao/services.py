...
def calcular_automacao(cidade: str, multiplicador: float, modo: str,
                        ...
                        extra_servicos_ids: Optional[List[str]] = None) -> dict:
    if modo == "pacote" and pacote_id:
        ...
        # Avulso e setup do pacote base (com multiplicador)
        ...
        setup = arredondar_dezena(nova_soma_avulso * discount_ratio)
        economia = max(0, nova_soma_avulso - setup)
        ...
        return {
            ...
            "detalhamento": {
                ...
                "nova_soma_avulso": nova_soma_avulso,
